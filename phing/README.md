...
> [!IMPORTANT]
> This is a cut-down version of our internal tool. It can only build installable ZIP files locally. It cannot publish a release. All release targets and their associated tooling are neutered in this version so that this repository does NOT classify as a “product with digital elements” under the EU CRA. If you think this is absurd, please 
